...
{
    [Table("PATIENTS")]
    [Index(nameof(ClientGuid), nameof(PatientAccountId), nameof(DeletedUniqifyingGuid), Name = "IX_PATIENTS", IsUnique = true)]
    public partial class Patient
    {
        ...
        [Required]
        [Column("MEDICAL_ALERT")]
        [StringLength(50)]
        [Unicode(false)]
        public string MedicalAlert { get; set; }
        [Required]
        [Column("CHRONIC_AILMENT")]
        [StringLength(50)]
        [Unicode(false)]
        public string ChronicAilment { get; set; }
        [Required]
        [Column("CONTINUOUS_MEDICATION")]
        [StringLength(50)]
        [Unicode(false)]
