...
{
    [Table("ESTIMATE_TEMPLATES_B")]
    public partial class EstimateTemplatesB
    {
        [Key]
        ...
        [Column("TITLE_SIZE")]
        public short TitleSize { get; set; }
        [Column("TITLE_BOLD")]
        public bool TitleBold { get; set; }
        [Column("TITLE_ITALICS")]
        public bool TitleItalics { get; set; }
        [Column("TITLE_ALIGN")]
        public short TitleAlign { get; set; }
        [Column("TITLE_COLOR")]
