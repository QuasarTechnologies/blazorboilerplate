...
namespace BlazorBoilerplate.Storage
{
    ...
    public class BusinessDbContext : MultiTenantIdentityDbContext<ApplicationUser, ApplicationRole, Guid, IdentityUserClaim<Guid>, ApplicationUserRole, IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>, IdentityUserToken<Guid>>, IMultiTenantDbContext
    {
      //  public DbSet<Client> Clients { get; set; }
        ...
        public BusinessDbContext(TenantInfo tenantInfo, DbContextOptions<BusinessDbContext> options, IUserSession userSession)
